...
usage() {
  cat <<'EOF'
Usage: scripts/run-cilium-kind-test-with-upstream-operator.sh [options]
...
focused ginkgo test. Uses the upstream Cilium operator (quay.io/cilium/cilium-ci:latest)
until the Rust operator is feature-complete.
